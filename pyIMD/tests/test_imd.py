...
class TestConfiguration(TestCase):
    ...
    def testSettingsNewProject(self):
        ...
        expected_result = {'_figure_units': 'cm', '_figure_name_pre_start_with_cell': 'FitWithCellData',
                           ...
                           '_pre_start_with_cell_path': 'C:\\Users\\localadmin\\ownCloud\\Projects\\Collaborations\\'
                                                        'David_Gotthold\\Showcase data\\Showcase data\\mass data\\'
                                                        '20190110_ShowCase_PLL_A.txt', '_measurements_path':
                           'C:\\Users\\localadmin\\ownCloud\\Projects\\Collaborations\\David_Gotthold\\Showcase'
                           ' data\\Showcase data\\mass data\\20190110_ShowCase_PLL_LongTerm.txt',
                           ...
                           '_figure_plot_every_nth_point': 1, '_project_folder_path':
                           'C:\\Users\\localadmin\\ownCloud\\Projects\\Collaborations\\David_Gotthold\\Showcase data\\'
                           'Showcase data\\mass data', '_selected_files': ['20190110_ShowCase_PLL_B.txt',
                           ...
                           '_frequency_offset': 0, '_pre_start_no_cell_path':
                           'C:\\Users\\localadmin\\ownCloud\\Projects\\Collaborations\\David_Gotthold\\Showcase data\\'
                           'Showcase data\\mass data\\20190110_ShowCase_PLL_B.txt', '_read_text_data_from_line': 23,
        ...
        file_path1 = "C:\\Users\\localadmin\\ownCloud\\Projects\\Collaborations\\David_Gotthold\\Showcase data\\" \
                     "Showcase data\\mass data\\20190110_ShowCase_PLL_B.txt"
        file_path2 = "C:\\Users\\localadmin\\ownCloud\\Projects\\Collaborations\\David_Gotthold\\Showcase data\\" \
                     "Showcase data\\mass data\\20190110_ShowCase_PLL_A.txt"
        file_path3 = "C:\\Users\\localadmin\\ownCloud\\Projects\\Collaborations\\David_Gotthold\\Showcase data\\" \
                     "Showcase data\\mass data\\20190110_ShowCase_PLL_LongTerm.txt"
