...
# -*- coding: utf-8 -*-
#
# pyIMD documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'pyIMD.tex', 'pyIMD Documentation',
     'Andreas P. Cuny', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyimd', 'pyIMD Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyIMD', 'pyIMD Documentation',
     author, 'pyIMD', 'One line description of project.',
     'Miscellaneous'),
]
